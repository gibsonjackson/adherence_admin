...
class _AddDoctorState extends State<AddParent> {
  ...
  validateForm(BuildContext context) async {
    if (!isLoading) {
      if (_doctorFormKey.currentState.validate()) {
        ...
        await firebaseHomeProvider.addUser(parentModel.toUserJson());
        await LoginRepo()
            .registerWithEmailPassword(_emailController.text, password);
        await firebaseHomeProvider
            .addParent(parentModel.toDoctorJson())
            .then((value) {
